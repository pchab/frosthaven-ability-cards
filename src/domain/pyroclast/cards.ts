	...
	[
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 54, y: 58 } }],
			slots: [
				{ x: 53, y: 169 },
				{ x: 83, y: 169 },
			],
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 167 } }],
			initiative: 68,
		},
		{
			level: "X",
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 130 } }],
			slots: [
				{ x: 39, y: 74 },
				{ x: 69, y: 74 },
				{ x: 99, y: 74 },
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 133 } }],
			initiative: 23,
		},
		{
			level: 1,
			name: "cooling",
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "circle", position: { x: 69, y: 125 } }],
			slots: [
				{ x: 39, y: 169 },
				{ x: 69, y: 169 },
				{ x: 99, y: 169 },
		...
		},
		{
			...
			name: "eruption",
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 146 } }],
			initiative: 47,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "quenched rage",
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 31 } }],
			slots: [
				{ x: 22.5, y: 154.5 },
				{ x: 52.5, y: 154.5 },
				{ x: 82, y: 154.5 },
		...
		},
		{
			...
			name: "under pressure",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 91, y: 44 } }],
			initiative: 85,
		},
		{
			level: 2,
		...
		},
		{
			...
			name: "searing smoke",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 74, y: 145 } }],
			initiative: 45,
		},
		{
			level: 3,
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 128 } }],
			slots: [
				{ x: 68, y: 83 },
				{ x: 98, y: 83 },
			],
		...
		},
		{
			...
			name: "living magma",
			actions: { top: "activeDiscard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 91, y: 134 } }],
			slots: [
				{ x: 53, y: 82 },
				{ x: 83, y: 82 },
			],
		...
		},
		{
			...
			name: "heat wave",
			actions: { top: "activeDiscard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 135 } }],
			slots: [{ x: 95, y: 83 }],
			initiative: 8,
		},
		{
		...
		},
		{
			...
			name: "rain of fire",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 75, y: 152 } }],
			initiative: 21,
		},
		{
			level: 6,
		...
		},
		{
			...
			name: "feed the beast",
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "circle", position: { x: 92, y: 129 } }],
			initiative: 27,
		},
		{
			level: 9,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 75, y: 129 } }],
			initiative: 9,
		},
	],
	pyroclastPath,
