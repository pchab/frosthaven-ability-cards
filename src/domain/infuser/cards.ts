	...
	[
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 87, y: 54 } }],
			initiative: 78,
		},
		{
			level: "X",
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 144 } }],
			initiative: 28,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 129 } }],
			initiative: 33,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 88, y: 48 } }],
			initiative: 47,
		},
		{
			level: 3,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 89, y: 176 } }],
			initiative: 18,
		},
		{
			level: 4,
		...
		},
		{
			...
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 166 } }],
			initiative: 91,
		},
		{
			level: 7,
			name: "diamondization",
			actions: { top: "activeDiscard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 86, y: 31 } }],
			initiative: 10,
		},
		{
			level: 7,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "diamond", position: { x: 89, y: 33 } }],
			initiative: 50,
		},
	],
	infuserPath,
