...
export const geminateCards: GeminateCard[] = createCards(
	[
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 132 } }],
			initiative: 20,
		},
		{
			level: 1,
			...
			form: "melee",
			availableEnhancements: [{ type: "square", position: { x: 90, y: 139 } }],
			initiative: 23,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "lose", bottom: "discard" },
			form: "ranged",
			availableEnhancements: [{ type: "square", position: { x: 90, y: 140 } }],
			initiative: 88,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "lose", bottom: "discard" },
			form: "ranged",
			availableEnhancements: [{ type: "square", position: { x: 61, y: 141 } }],
			initiative: 18,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "activeLost", bottom: "discard" },
			form: "melee",
			availableEnhancements: [{ type: "diamond", position: { x: 73, y: 152 } }],
			initiative: 17,
		},
		{
			level: 2,
		...
		},
		{
			...
			actions: { top: "lose", bottom: "activeDiscard" },
			form: "ranged",
			availableEnhancements: [{ type: "diamond", position: { x: 62, y: 47 } }],
			initiative: 50,
		},
		{
			level: 4,
		...
		},
		{
			...
			actions: { top: "activeLost", bottom: "discard" },
			form: "melee",
			availableEnhancements: [{ type: "square", position: { x: 74, y: 141 } }],
			initiative: 75,
		},
		{
			level: 5,
			...
			form: "ranged",
			availableEnhancements: [{ type: "square", position: { x: 89, y: 56 } }],
			initiative: 15,
		},
		{
			level: 6,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			form: "ranged",
			availableEnhancements: [{ type: "square", position: { x: 62, y: 147 } }],
			initiative: 92,
		},
		{
			level: 7,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 168 } }],
			initiative: 11,
		},
		{
			level: 9,
