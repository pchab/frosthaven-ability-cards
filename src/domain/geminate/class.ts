...
import { type GeminateCard, geminateCards } from "./cards";

export function isGeminate(
	frosthavenClass: FrosthavenClass<Card>,
): frosthavenClass is FrosthavenClass<GeminateCard> {
	return frosthavenClass.name === "Geminate";
}

export function isGeminateCards(
	fhClass: FrosthavenClass<Card>,
	cards: Card[],
): cards is GeminateCard[] {
