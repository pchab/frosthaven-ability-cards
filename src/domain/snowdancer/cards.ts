...
export const snowdancerCards: Card[] = createCards(
	[
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 141 } }],
			initiative: 31,
		},
		{
			level: 1,
			...
			availableEnhancements: [{ type: "diamond", position: { x: 65, y: 50 } }],
			initiative: 20,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "frigid growth",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 74, y: 147 } }],
			initiative: 70,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "zephyr barrier",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "square", position: { x: 58, y: 48 } }],
			initiative: 40,
		},
		{
			level: 5,
			name: "shifting snow",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 134 } }],
			initiative: 17,
		},
		{
			level: 5,
		...
		},
		{
			...
			name: "frozen brand",
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 74, y: 146 } }],
			initiative: 33,
		},
		{
			level: 6,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 89, y: 147 } }],
			initiative: 5,
		},
		{
			level: 9,
			name: "snowblind",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "diamond", position: { x: 44, y: 50 } }],
			initiative: 83,
		},
		{
			level: 9,
