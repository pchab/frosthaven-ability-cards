...
export const blinkbladeCards: Card[] = createCards(
	[
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 61, y: 129 } }],
			initiative: 52,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 73, y: 44 } }],
			initiative: 41,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 131 } }],
			initiative: 17,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 151 } }],
			initiative: 44,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 137 } }],
			initiative: 3,
		},
		{
			level: 5,
			...
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "diamond", position: { x: 60, y: 140 } }],
			initiative: 40,
		},
		{
			level: 6,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 71, y: 137 } }],
			initiative: 65,
		},
		{
			level: 7,
			name: "phasing blades",
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 141 } }],
			initiative: 63,
		},
		{
			level: 7,
