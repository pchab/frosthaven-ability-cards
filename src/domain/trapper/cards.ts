	...
	[
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 50 } }],
			initiative: 72,
		},
		{
			level: "X",
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 86, y: 54 } }],
			initiative: 30,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "spike pit",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 76, y: 52 } }],
			initiative: 47,
		},
		{
			level: 2,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "activeDiscard" },
			slots: [{ x: 71, y: 174 }],
			availableEnhancements: [{ type: "diamond", position: { x: 71, y: 50 } }],
			initiative: 45,
		},
		{
			level: 3,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 96, y: 61 } }],
			initiative: 31,
		},
		{
			level: 4,
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 96, y: 60 } }],
			initiative: 10,
		},
		{
			level: 5,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 139 } }],
			initiative: 26,
		},
		{
			level: 6,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "square", position: { x: 69, y: 60 } }],
			initiative: 13,
		},
		{
			level: 7,
			...
			availableEnhancements: [{ type: "square", position: { x: 80, y: 48 } }],
			initiative: 90,
		},
		{
			level: 7,
			...
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 175 } }],
			initiative: 8,
		},
		{
			level: 8,
		...
		},
		{
			...
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 146 } }],
			initiative: 23,
		},
		{
			level: 9,
