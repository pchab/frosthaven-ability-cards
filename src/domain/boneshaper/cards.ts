...
export const boneshaperCards: Card[] = createCards(
	[
		...
		},
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 41, y: 50 } }],
			initiative: 21,
		},
		{
			level: "X",
		...
		},
		{
			...
			name: "dark tidings",
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 152 } }],
			initiative: 43,
		},
		{
			level: 1,
			name: "decaying will",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "diamond", position: { x: 65, y: 41 } }],
			initiative: 46,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "fell remedy",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 57, y: 43 } }],
			initiative: 30,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 33 } }],
			initiative: 26,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "solid bones",
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 92, y: 149 } }],
			initiative: 32,
		},
		{
			level: 5,
		...
		},
		{
			...
			name: "twisted decree",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 58, y: 151 } }],
			initiative: 85,
		},
		{
			level: 7,
