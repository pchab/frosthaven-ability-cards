...
export const bladeswarmCards: Card[] = createCards(
	[
		...
		},
		{
			...
			initiative: 43,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 99, y: 51 } }],
		},
		{
			level: 2,
			...
			initiative: 12,
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "diamond", position: { x: 99, y: 46 } }],
		},
		{
			level: 3,
		...
		},
		{
			...
			initiative: 32,
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "diamond", position: { x: 98, y: 47 } }],
		},
		{
			level: 7,
