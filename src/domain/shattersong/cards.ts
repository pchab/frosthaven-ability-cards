	...
	[
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 126 } }],
		},
		{
			level: 2,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 89, y: 131 } }],
		},
		{
			level: 7,
		...
		},
		{
			...
			initiative: 14,
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "square", position: { x: 67, y: 45 } }],
		},
		{
			level: 4,
			...
			initiative: 25,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 89, y: 35 } }],
		},
		{
			level: 5,
			...
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 131 } }],
		},
		{
			level: 1,
			...
			availableEnhancements: [{ type: "diamond", position: { x: 71, y: 42 } }],
		},
		{
			level: 8,
			name: "feedback",
			initiative: 24,
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 127 } }],
		},
		{
			level: 1,
		...
		},
		{
			...
			initiative: 30,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 72, y: 58 } }],
		},
		{
			level: "X",
		...
		},
		{
			...
			initiative: 40,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 140 } }],
		},
		{
			level: 5,
		...
		},
		{
			...
			initiative: 73,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 70, y: 144 } }],
		},
		{
			level: 3,
		...
		},
		{
			...
			initiative: 13,
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "diamond", position: { x: 72, y: 38 } }],
		},
		{
			level: 1,
		...
		},
		{
			...
			initiative: 5,
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 132 } }],
		},
	],
	shattersongPath,
);
