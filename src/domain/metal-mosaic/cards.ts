...
export const metalMosaicCards: Card[] = createCards(
	[
		...
		},
		{
			...
			initiative: 64,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 144 } }],
		},
		{
			level: 1,
			name: "power core",
			...
			availableEnhancements: [{ type: "circle", position: { x: 70, y: 126 } }],
		},
		{
			level: 1,
		...
		},
		{
			...
			initiative: 17,
			actions: { top: "activeDiscard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 128 } }],
		},
		{
			level: 1,
			name: "steel piston",
		...
		},
		{
			...
			initiative: 30,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 139 } }],
		},
		{
			level: 3,
		...
		},
		{
			...
			initiative: 15,
			actions: { top: "activeDiscard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 127 } }],
		},
		{
			level: 4,
		...
		},
		{
			...
			initiative: 21,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 89, y: 28 } }],
		},
		{
			level: 5,
			...
			initiative: 11,
			actions: { top: "activeDiscard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 52 } }],
		},
		{
			level: 5,
			name: "radiation",
		...
		},
		{
			...
			initiative: 45,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 70, y: 146 } }],
		},
		{
			level: 6,
			name: "steam core",
		...
		},
		{
			...
			initiative: 11,
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 124 } }],
		},
		{
			level: 8,
			name: "piston barrage",
		...
		},
		{
			...
			initiative: 79,
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "square", position: { x: 65, y: 91 } }],
		},
		{
			level: 9,
			name: "unstable core",
