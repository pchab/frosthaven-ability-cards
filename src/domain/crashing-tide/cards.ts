	...
	[
		{
			...
			initiative: 42,
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 135 } }],
		},
		{
			level: "X",
			name: "rising flood",
		...
		},
		{
			...
			initiative: 15,
			availableEnhancements: [{ type: "circle", position: { x: 70, y: 141 } }],
		},
		{
			level: 1,
			...
			actions: { top: "discard", bottom: "activeDiscard" },
			initiative: 45,
			availableEnhancements: [{ type: "diamond", position: { x: 50, y: 48 } }],
		},
		{
			level: 1,
			name: "crashing surge",
		...
		},
		{
			...
			actions: { top: "discard", bottom: "activeDiscard" },
			initiative: 86,
			availableEnhancements: [{ type: "diamond", position: { x: 62, y: 59 } }],
		},
		{
			level: 1,
			name: "pool of power",
			actions: { top: "lose", bottom: "activeDiscard" },
			initiative: 41,
			availableEnhancements: [{ type: "diamond", position: { x: 91, y: 39 } }],
		},
		{
			level: 1,
			name: "rancid brine",
		...
		},
		{
			...
			actions: { top: "activeDiscard", bottom: "discard" },
			initiative: 25,
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 136 } }],
		},
		{
			level: 1,
			name: "skitter",
			actions: { top: "discard", bottom: "activeDiscard" },
			initiative: 51,
			availableEnhancements: [{ type: "square", position: { x: 89, y: 59 } }],
		},
		{
			level: 1,
			name: "soft flesh",
		...
		},
		{
			...
			actions: { top: "activeDiscard", bottom: "discard" },
			initiative: 26,
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 142 } }],
		},
		{
			level: 4,
			name: "clean sweep",
			actions: { top: "discard", bottom: "discard" },
			initiative: 65,
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 132 } }],
		},
		{
			level: 5,
			name: "sodden soil",
		...
		},
		{
			...
			actions: { top: "discard", bottom: "lose" },
			initiative: 33,
			availableEnhancements: [{ type: "diamond", position: { x: 69, y: 41 } }],
		},
		{
			level: 7,
		...
		},
		{
			...
			actions: { top: "activeDiscard", bottom: "discard" },
			initiative: 73,
			availableEnhancements: [{ type: "square", position: { x: 89, y: 152 } }],
		},
		{
			level: 8,
			name: "ebb and flow",
