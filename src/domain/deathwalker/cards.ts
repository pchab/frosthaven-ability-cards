...
export const deathwalkerCards: Card[] = createCards(
	[
		...
		},
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 39, y: 54 } }],
			initiative: 26,
		},
		{
			level: "X",
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 71, y: 34 } }],
			initiative: 14,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "eclipse",
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 153 } }],
			initiative: 86,
		},
		{
			level: 1,
			name: "fluid night",
			actions: { top: "discard", bottom: "activeDiscard" },
			availableEnhancements: [{ type: "diamond", position: { x: 90, y: 37 } }],
			initiative: 24,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "fleeting dusk",
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 40, y: 47 } }],
			initiative: 36,
		},
		{
			level: 4,
			name: "pulled across",
			actions: { top: "lose", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 134 } }],
			initiative: 77,
		},
		{
			level: 5,
		...
		},
		{
			...
			name: "medium",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 32 } }],
			initiative: 55,
		},
		{
			level: 6,
		...
		},
		{
			...
			name: "vengeful storm",
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 38 } }],
			initiative: 18,
		},
		{
			level: 7,
		...
		},
		{
			...
			name: "frozen in fear",
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 153 } }],
			initiative: 21,
		},
		{
			level: 8,
			...
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 93, y: 129 } }],
			initiative: 80,
		},
		{
			level: 9,
			name: "black lance",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 74, y: 138 } }],
			initiative: 16,
		},
		{
			level: 9,
			...
			availableEnhancements: [{ type: "diamond", position: { x: 65, y: 67 } }],
			initiative: 72,
		},
	],
	deathwalkerPath,
