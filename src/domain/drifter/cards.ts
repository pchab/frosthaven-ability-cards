...
export const drifterCards: Card[] = createCards(
	[
		...
		},
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 70, y: 34 } }],
			initiative: 31,
		},
		{
			level: "X",
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 70, y: 137 } }],
			initiative: 71,
		},
		{
			level: 1,
			name: "deadly shot",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 64, y: 62 } }],
			initiative: 32,
		},
		{
			level: 1,
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 57, y: 62 } }],
			initiative: 23,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 90, y: 43 } }],
			initiative: 76,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "dual bow",
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 66, y: 60 } }],
			initiative: 26,
		},
		{
			level: 3,
			...
			availableEnhancements: [{ type: "diamond", position: { x: 65, y: 58 } }],
			initiative: 32,
		},
		{
			level: 4,
		...
		},
		{
			...
			name: "break through",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 91, y: 135 } }],
			initiative: 34,
		},
		{
			level: 5,
			...
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 128 } }],
			initiative: 91,
		},
		{
			level: 6,
			...
			availableEnhancements: [{ type: "circle", position: { x: 91, y: 138 } }],
			initiative: 56,
		},
		{
			level: 6,
		...
		},
		{
			...
			name: "use every part",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 71, y: 41 } }],
			initiative: 18,
		},
	],
	drifterPath,
