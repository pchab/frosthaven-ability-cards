	...
	[
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 172 } }],
			initiative: 27,
		},
		{
			level: "X",
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 153 } }],
			initiative: 22,
		},
		{
			level: 4,
		...
		},
		{
			...
			name: "disassemble",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 60 } }],
			initiative: 20,
		},
		{
			level: 9,
