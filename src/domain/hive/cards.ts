...
export const hiveCards: Card[] = createCards([
  ...
  { level: 'X', name: 'shocking pulse', actions: { top: CardActions.lose, bottom: CardActions.discard } },
  ...
  { level: 1, name: 'plated defense', actions: { top: CardActions.activeLost, bottom: CardActions.discard } },
  ...
  { level: 4, name: 'plague protocol', actions: { top: CardActions.lose, bottom: CardActions.activeDiscard } },
  { level: 5, name: 'code geminate', actions: { top: CardActions.discard, bottom: CardActions.discard } },
  { level: 5, name: 'net dispersal', actions: { top: CardActions.lose, bottom: CardActions.discard } },
