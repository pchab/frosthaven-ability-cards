...
export const deepwraithCards: Card[] = createCards(
	[
		...
		},
		{
			...
			name: "black scythe",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 90, y: 50 } }],
			initiative: 45,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "ink cloud",
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "square", position: { x: 47, y: 53 } }],
			initiative: 28,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 62, y: 48 } }],
			initiative: 96,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 91, y: 152 } }],
			initiative: 22,
		},
		{
			level: 1,
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 140 } }],
			initiative: 63,
		},
		{
			level: 1,
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 91, y: 141 } }],
			initiative: 20,
		},
		{
			level: 1,
		...
		},
		{
			...
			name: "lie in wait",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 140 } }],
			initiative: 98,
		},
		{
			level: 2,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 90, y: 47 } }],
			initiative: 40,
		},
		{
			level: 4,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 173 } }],
			initiative: 48,
		},
		{
			level: 5,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 138 } }],
			initiative: 30,
		},
		{
			level: 7,
		...
		},
		{
			...
			name: "hasten the end",
			actions: { top: "discard", bottom: "lose" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 129 } }],
			initiative: 65,
		},
		{
			level: 8,
		...
		},
		{
			...
			name: "unseen horror",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "diamond", position: { x: 91, y: 37 } }],
			initiative: 19,
		},
		{
			level: 9,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "diamond", position: { x: 44, y: 57 } }],
			initiative: 12,
		},
	],
	deepwraithPath,
