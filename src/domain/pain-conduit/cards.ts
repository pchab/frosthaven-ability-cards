...
export const painConduitCards: Card[] = createCards(
	[
		...
		},
		{
			...
			name: "blood ritual",
			actions: { top: "discard", bottom: "activeLost" },
			availableEnhancements: [{ type: "diamond", position: { x: 72, y: 46 } }],
			initiative: 56,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 89, y: 138 } }],
			initiative: 43,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "activeLost", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 130 } }],
			initiative: 61,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "diamond", position: { x: 71, y: 46 } }],
			initiative: 78,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 131 } }],
			initiative: 30,
		},
		{
			level: 3,
		...
		},
		{
			...
			name: "hopelessness",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 137 } }],
			initiative: 83,
		},
		{
			level: 6,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 71, y: 142 } }],
			initiative: 22,
		},
		{
			level: 9,
