	...
	[
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 90, y: 134 } }],
			initiative: 17,
		},
		{
			level: "X",
		...
		},
		{
			...
			name: "shard launch",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 95, y: 50 } }],
			initiative: 52,
		},
		{
			level: 1,
			name: "cold boulder",
			actions: { top: "activeDiscard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 89, y: 143 } }],
			initiative: 70,
		},
		{
			level: 1,
		...
		},
		{
			...
			availableEnhancements: [{ type: "square", position: { x: 89, y: 132 } }],
			initiative: 23,
		},
		{
			level: 1,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 162 } }],
			initiative: 67,
		},
		{
			level: 2,
		...
		},
		{
			...
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "square", position: { x: 90, y: 146 } }],
			initiative: 51,
		},
		{
			level: 4,
		...
		},
		{
			...
			name: "preserved fury",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 89, y: 50 } }],
			initiative: 49,
		},
		{
			level: 6,
			name: "glacier slam",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "circle", position: { x: 88, y: 135 } }],
			initiative: 84,
		},
		{
			level: 6,
		...
		},
		{
			...
			availableEnhancements: [{ type: "circle", position: { x: 90, y: 134 } }],
			initiative: 73,
		},
		{
			level: 7,
		...
		},
		{
			...
			name: "draw strength",
			actions: { top: "discard", bottom: "discard" },
			availableEnhancements: [{ type: "diamond", position: { x: 63, y: 40 } }],
			initiative: 28,
		},
		{
			level: 8,
