...
export default function ConnectForm() {
	...
	return (
		<form
			action={submit}
			className="bg-linear-to-b from-black to-blue-500 rounded-lg grid grid-cols-4 gap-4 justify-items-center items-center p-4 border-2 border-solid"
		>
			<h3 className="col-span-full text-xl">
				Connect to <SecretaryLink>GH Secretary</SecretaryLink>
			</h3>
			...
			<input
				required
				className="col-span-3 bg-black min-w-96"
				type="text"
				name="secretary-host"
				defaultValue="wss://gloomhaven-secretary.de:8443/"
			/>
			...
			<input
				...
				type="text"
				name="secretary-id"
				placeholder="GH Secretary ID"
			/>

			<div className="col-span-full">
				<Button label="Connect to GH Secretary" type="submit">
					Connect
				</Button>
			</div>
