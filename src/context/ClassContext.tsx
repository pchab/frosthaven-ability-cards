...
import type {
	FrosthavenClass,
	FrosthavenClassNames,
} from "@/domain/frosthaven-class.type";
...
export default function ClassProvider({
	...
	const fhClass = frosthavenClasses.find(({ name }) => name === fhClassName);
	...
	return <ClassContext value={fhClass}>{children}</ClassContext>;
}
